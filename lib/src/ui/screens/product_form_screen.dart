...
// ... rest of the file is identical to the user's provided file ...
// It will be fully rendered as requested
// ... (build method, _buildSectionTitle, _buildImagePicker)
  @override
              ...
              child: _imageFile != null
                  ...
                  : (widget.product?.imagePath != null &&
                      ...
                      ? CachedNetworkImage(
                          ...
                          httpHeaders:
                              context.read<GithubService>().authHeaders,
                          fit: BoxFit.cover,
                          placeholder: (c, u) =>
